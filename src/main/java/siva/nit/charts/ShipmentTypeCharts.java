...
public class ShipmentTypeCharts {
	...
	public void generatePieChart(String path, List<Object[]> data) {
		...
		JFreeChart jFreeChart = ChartFactory.createPieChart3D("ShipmentType Modes", defaultPieDataset, true, true,
				false);
		//3.save as Image Using ChartUtils
		try {
			ChartUtils.saveChartAsJPEG(new File(path+"/resources/images/ShipmentTypePieChart.jpg"), jFreeChart, 400, 400);
		} catch (IOException e) {
	...
	public void generateBarChart(String path, List<Object[]> data) {
		...
		//2.create JFreeChart Using ChartFactory
		JFreeChart jFreeChart=ChartFactory.createBarChart("ShipmentType Modes", "Modes", "Count",defaultCategoryDataset);
